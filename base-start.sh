...
chmod +x ./base/03-components/04-runc/install-runc.sh
...
#chmod +x ./base/02-cri/containerd/binarymode/repo.sh
#./base/02-cri/containerd/binarymode/repo.sh --http_proxy="http://192.168.3.220:7890" --https_proxy="http://192.168.3.220:7890"

# 全部节点安装kubernetes组件
# --kubernetes_version: kubernetes仓库版本, 默认v1.32, 也可以是 v1.31,v1.30, v1.28
