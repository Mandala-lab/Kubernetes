...
./base/01-env/deb/01-config.sh --trace

chmod +x ./base/01-env/deb/02-ipvs.sh
./base/01-env/deb/02-ipvs.sh --trace

chmod +x ./base/01-env/deb/03-allow-port.sh
./base/01-env/deb/03-allow-port.sh --trace

chmod +x ./base/02-cri/containerd/binarymode/01-install.sh
./base/02-cri/containerd/binarymode/01-install.sh --proxy=y --install=n --version="1.7.17" --trace

chmod +x ./base/02-cri/containerd/binarymode/02-config.sh
./base/02-cri/containerd/binarymode/02-config.sh --trace
...
./base/02-cri/containerd/binarymode/03-install-runc.sh --proxy=y --install=y --trace

chmod +x ./base/02-cri/containerd/binarymode/03-repo.sh
./base/02-cri/containerd/binarymode/03-repo.sh --trace
...
./base/03-components/deb/template.sh --remove=n --version="v1.30" --trace
...
./base/03-components/01-crictl/01-install.sh --proxy=y --install=y --version="v1.30.0" --trace
