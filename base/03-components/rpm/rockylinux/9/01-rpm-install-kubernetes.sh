...
ARCH="arm64"
wget -t 2 -T 240 -N -S -progress=dot https://github.com/containerd/containerd/releases/download/${CONTAINERD_VERSION}/containerd-${CONTAINERD_VERSION}-linux-${ARCH}.tar.gz
...
#wget -t 2 -T 240 -N -S -progress=dot https://github.com/containernetworking/plugins/releases/download/v1.4.0/cni-plugins-linux-arm64-v1.4.0.tgz
...
VERSION="v1.29.0"
ARCH="arm64"
wget -t 2 -T 240 -N -S -progress=dot https://github.com/kubernetes-sigs/cri-tools/releases/download/${VERSION}/crictl-${VERSION}-linux-${ARCH}.tar.gz
...
#VERSION="v3.5.12"
#ARCH="arm64"
#wget -t 2 -T 240 -N -S -progress=dot https://github.com/etcd-io/etcd/releases/download/${VERSION}/etcd-${VERSION}-linux-${ARCH}.tar.gz
...
VERSION="v3.13.2"
ARCH="arm64"
wget -t 2 -T 240 -N -S -progress=dot https://mirrors.huaweicloud.com/helm/${VERSION}/helm-${VERSION}-linux-${ARCH}.tar.gz
...
# 下载专属监控面板
wget -t 2 -T 240 -N -S -progress=dot https://mirrors.chenby.cn/https://raw.githubusercontent.com/cilium/cilium/1.12.1/examples/kubernetes/addons/prometheus/monitoring-example.yaml
sed -i "s#docker.io/#m.daocloud.io/docker.io/#g" monitoring-example.yaml
kubectl  apply -f monitoring-example.yaml

wget -t 2 -T 240 -N -S -progress=dot https://mirrors.chenby.cn/https://raw.githubusercontent.com/cilium/cilium/master/examples/kubernetes/connectivity-check/connectivity-check.yaml
...
# 下载
wget -t 2 -T 240 -N -S -progress=dot https://mirrors.chenby.cn/https://github.com/kubernetes-sigs/metrics-server/releases/latest/download/components.yaml
...
# ingress安装
wget -t 2 -T 240 -N -S -progress=dot https://mirrors.chenby.cn/https://raw.githubusercontent.com/kubernetes/ingress-nginx/main/deploy/static/provider/cloud/deploy.yaml
