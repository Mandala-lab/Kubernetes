...
#sed -i 's#sandbox = .*#sandbox = "k8s.m.daocloud.io:3.9"#' "$CONTAINERD_CONFIG_FILE_PATH"
sed -i 's#sandbox = .*#sandbox = "registry.cn-hangzhou.aliyuncs.com/google_containers/pause:3.9"#' "$CONTAINERD_CONFIG_FILE_PATH"
