...
export CIDR="192.168.3.160/24"
export GATEWAY="192.168.3.1"
export DNS1="8.8.8.8"
export DNS2="180.184.1.1"
export DEVICE="enp0s5"
nmcli con show
export UUID="045c8b57-c5e3-32ce-8d9d-9a09ec7914b9"
...
nmcli con add type bridge-slave ifname enp0s5 master eth0
nmcli con up eth0
nmcli con mod eth0 ipv4.addresses $CIDR
nmcli con mod eth0 ipv4.method manual
nmcli con mod eth0 ipv4.gateway $GATEWAY
nmcli con mod eth0 ipv4.dns $DNS1,$DNS2
nmcli con mod eth0 ipv4.addresses $HOST
nmcli con mod eth0 ipv4.method manual;
...
export IP="192.168.3.160 192.168.3.152 192.168.3.155"
export SSHPASS=root
for HOST in $IP;do
